...
{
    public interface ICustomMessagingCenter
    {
    ...
    public class CustomMessagingCenter : ICustomMessagingCenter
    {
        /// <include file="../../docs/Microsoft.Maui.Controls/CustomMessagingCenter.xml" path="//Member[@MemberName='Instance']/Docs/*" />
        public static ICustomMessagingCenter Instance { get; } = new CustomMessagingCenter();
        ...
        void ICustomMessagingCenter.Send<TSender, TArgs>(TSender sender, string message, TArgs args)
        {
            if (sender == null)
        ...
        void ICustomMessagingCenter.Send<TSender>(TSender sender, string message)
        {
            if (sender == null)
                throw new ArgumentNullException(nameof(sender));
        ...
        void ICustomMessagingCenter.Subscribe<TSender, TArgs>(object subscriber, string message, Action<TSender, TArgs> callback, TSender source)
        {
            if (subscriber == null)
        ...
        void ICustomMessagingCenter.Subscribe<TSender>(object subscriber, string message, Action<TSender> callback, TSender source)
        {
            if (subscriber == null)
                throw new ArgumentNullException(nameof(subscriber));
            if (callback == null)
        ...
        void ICustomMessagingCenter.Unsubscribe<TSender, TArgs>(object subscriber, string message)
        {
        ...
        void ICustomMessagingCenter.Unsubscribe<TSender>(object subscriber, string message)
        {
        ...
        {
            (Instance as CustomMessagingCenter)?._subscriptions.Clear();
        }
    }
}